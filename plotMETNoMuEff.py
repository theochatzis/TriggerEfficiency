...
def main(args):
    ...
    variables  = ["metNoMu_pt", "pv"]
    triggers   = ["passed", "passtrig_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight", "passtrig_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_FilterHF"]
    ...
    for var in variables:
        ...
        for fs in args.formats:
            savename = f'plots/TrgEffs_METNoMu_{var}{fs}'
            c.SaveAs(savename)
    ...
    den = fdir.Get('h_metNoMu_pt_vs_pv_all')
    num = fdir.Get('h_metNoMu_pt_vs_pv_passed')
...
if __name__ == "__main__":
    ...
    VERBOSE       = True
    YEAR          = "2023"
    TRGROOTFILE   = "histos_METNoMuTrigNanoAOD.root"
    FORMATS       = ['.png', '.pdf']
